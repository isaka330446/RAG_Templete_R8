...
def meeting_events(
    ...
    source_type: str | None = Query(default=None, pattern="^(slide|minutes)$"),
    limit: int = Query(default=100, ge=1, le=500),
):
    return {
        "events": engine.event_store.query(
...
def admin_index_status():
    ...
    return {
        ...
        "chunks": {
            ...
            "meeting_events": jsonl_summary("data/meeting_events/meeting_events.jsonl"),
        },
