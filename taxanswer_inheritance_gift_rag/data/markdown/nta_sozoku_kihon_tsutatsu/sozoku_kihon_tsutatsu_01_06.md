...
source_url: "https://www.nta.go.jp/law/tsutatsu/kihon/sisan/sozoku2/01/06.htm"
document_type: "法令解釈通達"
corpus_id: "nta_sozoku_kihon_tsutatsu"
tax_type: "相続税"
source_site: "国税庁"
original_filename: "01__06_第9条《その他の利益の享受》関係.md"
...
- 通達名: 相続税法基本通達
- 税目: 相続税
- 出典URL: https://www.nta.go.jp/law/tsutatsu/kihon/sisan/sozoku2/01/06.htm
...
[画像: A×C÷B＝そのものの親族等から贈与により取得したものとする募集株式引受権数]
...
[画像: 新株の発行後の１株当たりの価格（A）×（その物の新株の発行前における所有株式数（B）＋その者が取得した新株の数（C））−（新株の発行前の１株当たりの価格（D）×その者の新株の発行前における所有株式数（B）＋新株の１株当たちの払込金額（E）×その物が取得した新株の数（C））]

(2) 親族等である失権株主のそれぞれから贈与により取得したものとする利益の金額

[画像: その者が受けた利益の総額×親族等である各失権株主が与えた利益の金額（G）÷各失権株主が与えた利益の総額（F）]

(注)

1 (1)の算式中の「A」は次により計算した価額による。

[画像: （D×新株の発行前の発行済株式の総数（H））＋（E×新株の発行により出資の履行があった新株の総数（I））÷（H＋I））]
