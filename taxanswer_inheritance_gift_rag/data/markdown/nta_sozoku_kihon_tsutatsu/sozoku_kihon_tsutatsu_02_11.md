...
source_url: "https://www.nta.go.jp/law/tsutatsu/kihon/sisan/sozoku2/02/11.htm"
document_type: "法令解釈通達"
corpus_id: "nta_sozoku_kihon_tsutatsu"
tax_type: "相続税"
source_site: "国税庁"
original_filename: "02__11_第21条の6《贈与税の配偶者控除》関係.md"
...
- 通達名: 相続税法基本通達
- 税目: 相続税
- 出典URL: https://www.nta.go.jp/law/tsutatsu/kihon/sisan/sozoku2/02/11.htm
...
[画像: 当該家屋のうちその居住の用に専ら供している部分の床面積(A)+当該家屋のうちその居住の用と居住の用以外の用途に併用されている部分の床面積(B)×(A÷当該家屋の床面積-B)]

- （2） 当該土地等のうちその居住の用に供している部分は、次の算式により計算した面積に相当する部分とする。

[画像: 当該土地等のうちその居住の用に専ら供している部分の面積+当該土地等のうちその居住の用と居住の用以外の用とに併用されている部分の面積×(当該家屋の面積のうち(1)の算式により計算した面積÷当該家屋の床面積)]
